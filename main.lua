...
--------------------------------------------------------
-- Auto M1 Cid (tốc độ 0.1s - bản gốc)
--------------------------------------------------------
...
--------------------------------------------------------
-- Auto M1 Cid (Siêu Nhanh - spam 50k lần/0.1s)
--------------------------------------------------------
local RunService = game:GetService("RunService")
getgenv().UltraM1 = false
createButton("Auto M1 Cid (Siêu Nhanh)", 85, function()
	getgenv().UltraM1 = not getgenv().UltraM1
	pcall(function()
		game:GetService("StarterGui"):SetCore("SendNotification", {
			Title = "Auto M1 (Siêu nhanh)",
			Text = getgenv().UltraM1 and "Đã bật spam 50k lần/0.1s!" or "Đã tắt!",
			Duration = 2
		})
	end)

	if getgenv().UltraM1 then
		task.spawn(function()
			while getgenv().UltraM1 do
				local plr = game.Players.LocalPlayer
...
-- Auto Kaido Quest
--------------------------------------------------------
createButton("Auto Kaido Quest", 125, function()
	pcall(function()
...
-- Khánh Duy 1
--------------------------------------------------------
createButton("Auto Khánh Duy 1", 165, function()
	pcall(function()
...
-- Khánh Duy 2
--------------------------------------------------------
createButton("Auto Khánh Duy 2", 205, function()
	pcall(function()
...
createButton("Kill Aura Player", 245, function()
...
-- Thoát GUI
--------------------------------------------------------
createButton("Đóng GUI", 300, function()
	ScreenGui:Destroy()
end)
